...
<section class="footer_main">
    ...
    <section class="aciklamasss">
        <p>Erkekler için kumaş satışı yapmak amacıyla 1938 yılında kurulan Kiğılı, 1965 yılında üretime geçerek ilk satış mağazasını dönemin en popüler alışveriş bölgelerinden biri olan İstiklal Caddesi’nde açtı....  Devamını Oku</p>
    </section>
    <section>
        <section class="footer_middle">
                ...
                <section class="footer">
                    ...
                    <ul>
                        ...
                        <li><i class='bx bxl-instagram-alt' ></i> İnstagram</li>
                        <li><i class='bx bxl-pinterest-alt' ></i> Pinterest</li>
                        <li> <i class='bx bxl-youtube' ></i> Youtube</li>
                        <li> <i class='bx bxl-blogger' ></i> Çeyiz Blog</li>
                    </ul>
                </section>
        </section>
    </section>
